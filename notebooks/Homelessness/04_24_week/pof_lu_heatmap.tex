...
colorbar,
colorbar style={ytick={1,1.1,1.2,1.3,1.4,1.5,1.6},yticklabels={1.0,1.1,1.2,1.3,1.4,1.5,1.6},ylabel={}},
colormap={mymap}{[1pt]
...
point meta max=1.54834245286664,
point meta min=1,
tick align=outside,
tick pos=left,
x grid style={white},
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=10, ymax=0] {pof_lu_heatmap_tikz.png};
\end{axis}
